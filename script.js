function submitForm() {
    ...
    let northIndian = document.getElementById("north-indian");
    ...
    if(northIndian.value){
        foodChoice = "North Indian"
    }else if(southIndian.value){
        foodChoice = "South Indian"
    }else if(japanese.value){
        foodChoice = "Japanese"
